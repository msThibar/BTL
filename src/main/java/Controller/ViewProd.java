...
public class ViewProd extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<BillLine> list= dao.getByProd(id);
        request.setAttribute("prod", id);
        request.setAttribute("listBL", list);
        request.getRequestDispatcher("ViewProd.jsp").forward(request, response);
    }
